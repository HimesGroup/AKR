ui <- fluidPage(
    ...
    navbarPage(
        ...
        tabPanel(
            ...
            tabsetPanel(
                tabPanel("Overview", imageOutput("family_tree")),
                tabPanel("All AKRs",
                         fluidRow(column(6, imageOutput("all_akrs_a")),
                                  column(6, imageOutput("all_akrs_b")))),
                tabPanel("Bacterial AKRs",
                         fluidRow(column(6, imageOutput("bacteria_a")),
                                  column(6, imageOutput("bacteria_b")))),
                tabPanel("Fungal AKRs",
                         fluidRow(column(6, imageOutput("fungus_a")),
                                  column(6, imageOutput("fungus_b")))),
                tabPanel("Plant AKRs",
                         fluidRow(column(6, imageOutput("plant_a")),
                                  column(6, imageOutput("plant_b")))),
                tabPanel("Mammalian AKRs",
                         fluidRow(column(6, imageOutput("mammal_a")),
                                  column(6, imageOutput("mammal_b")))),
                tabPanel("Rodent AKRs",
                         fluidRow(column(6, imageOutput("rodent_a")),
                                  column(6, imageOutput("rodent_b")))),
                tabPanel("Human AKRs",
                         fluidRow(column(6, imageOutput("human_a")),
                                  column(6, imageOutput("human_b"))))
            )
        ),
        tabPanel(
